...
import com.randomcalendar.databinding.FragmentRandomItemsBinding
import com.randomcalendar.databinding.ItemRandomItemBinding
    ...
    inner class ViewHolder(private val b: ItemRandomItemBinding) : RecyclerView.ViewHolder(b.root) {
        fun bind(item: RandomItem) {
            ...
            b.btnItemExpand.setImageResource(
                if (isExpanded) com.randomcalendar.R.drawable.ic_chevron_up
