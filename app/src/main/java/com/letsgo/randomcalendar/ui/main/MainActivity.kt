...
import com.letsgo.randomcalendar.ui.calendar.CalendarAdapter
import com.letsgo.randomcalendar.ui.calendar.CalendarBuilder
import com.letsgo.randomcalendar.ui.common.ThemeHelper
import com.letsgo.randomcalendar.ui.common.ViewModelFactory
import com.letsgo.randomcalendar.ui.daydetail.DayDetailBottomSheet
import com.letsgo.randomcalendar.ui.randomlist.RandomListActivity
import com.letsgo.randomcalendar.ui.theme.ThemeActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupCalendar() {
        ...
        calendarAdapter.applyTheme(com.letsgo.randomcalendar.ui.common.ThemeHelper.load(this))
    }
    ...
    private fun setupSlogan() {
        val savedSlogan = prefs.getString("slogan", getString(com.letsgo.randomcalendar.R.string.default_slogan))
    ...
    private fun saveSlogan() {
        val text = binding.etSlogan.text.toString().ifBlank {
            getString(com.letsgo.randomcalendar.R.string.default_slogan)
        }
    ...
    private fun collapseMemoField() {
        ...
        binding.tvMemo.setTextColor(
            getColor(if (text.isBlank()) com.letsgo.randomcalendar.R.color.text_secondary
                     else com.letsgo.randomcalendar.R.color.text_primary)
        )
    ...
    private fun observeViewModel() {
        ...
        viewModel.currentMonthMemo.observe(this) { memo ->
            if (binding.etMemo.visibility == android.view.View.GONE) {
                ...
                binding.tvMemo.setTextColor(
                    getColor(if (content.isBlank()) com.letsgo.randomcalendar.R.color.text_secondary
                             else com.letsgo.randomcalendar.R.color.text_primary)
                )
            }
        }
